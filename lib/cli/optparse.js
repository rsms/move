...
Parser.prototype.width = function() {
  if (process.stdout.isTTY) {
    return require('tty').getWindowSize(process.stdout.fd)[1];
  } else {
    return 80;
  }
}
