...
exports.compile = function compile(source, options) {
  ...
  if (op.automaticVarDeclarations) {
    ast = astMutators.first_time_var_delc(ast, [
        // globals (covers node.js and most browers)
        'global', 'process', 'require', 'console', 'window', 'document',
...
try {
  ...
  evalFunc = runInThisContext;
} catch (e) {}
exports.eval = function (source, options) {
  if (!options || typeof options !== 'object')
    options = {filename: options || '<input>'};
  var jsSource = exports.compile(source, options);
  return evalFunc(jsSource, options.filename);
}
